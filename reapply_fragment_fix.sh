...
echo "=== Reapply the fragment fix (verified correct last run, just got reverted) ==="
python3 - << 'PYEOF'
...
echo ""
echo "=== Correct local syntax check: no --loader flag needed for .jsx files, just parse it ==="
npx esbuild src/components/omega/MessageBubble.jsx --bundle --outfile=/data/data/com.termux/files/home/mb_test_out.js > /data/data/com.termux/files/home/esbuild_check.txt 2>&1
if [ $? -ne 0 ]; then
