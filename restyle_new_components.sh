...
git add src/components/omega/LiveActivityBar.jsx src/components/omega/VoiceToggle.jsx
git status
git commit -m "style: match LiveActivityBar and VoiceToggle to existing teal/status token system"
